                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah Data Jabatan</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jabatanCount }}
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Jumlah Data PK</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $pkCount }}
                                            </div>
                                        </div>
                                        <div class="col-auto">
