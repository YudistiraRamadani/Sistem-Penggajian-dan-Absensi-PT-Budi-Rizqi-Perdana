                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        @foreach ($absensi as $item)
                            <div class="col-xl-4 col-md-6 mb-4"> <!-- Increase width of the card -->
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="h5 font-weight-bold text-primary text-uppercase mb-1">
                                                    {{ $item->judul_absensi }}</div>
                                                <div class="small mb-0 font-weight-bold text-gray-800">
                                                    {{ $item->deskripsi_absensi }}</div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                            </div>
                                        </div>
                                        <a href="{{ route('user.detailAbsensi', $item->id_absensi) }}"
                                            class="btn btn-primary mt-3">Lihat Detail</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
